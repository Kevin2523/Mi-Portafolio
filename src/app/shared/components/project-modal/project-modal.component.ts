      ...
      >
        ...
        >
          ...
          <div class="flex-1 overflow-y-auto p-6 md:p-8 space-y-8">
            ...
            <!-- Description -->
            <div class="space-y-4">
              <h3 class="text-lg font-bold font-display text-slate-800 dark:text-white">{{ 'projects.subtitle' | t }}</h3>
              <p class="text-slate-600 dark:text-slate-400 leading-relaxed whitespace-pre-line">
                {{ project.longDescription | t }}
              </p>
            </div>

            <!-- Role -->
            <div>
              <h3 class="text-lg font-bold font-display text-slate-800 dark:text-white mb-2">{{ 'about.info.role' | t }}</h3>
              <p class="text-slate-600 dark:text-slate-400">{{ project.role | t }}</p>
            </div>

            <!-- Technologies -->
            <div>
              <h3 class="text-lg font-bold font-display text-slate-800 dark:text-white mb-3">{{ 'skills.title' | t }}</h3>
